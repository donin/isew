...
<?php if (!$order->order_created){?>
    <div><?php print _JSHOP_FINISHED?>: <input type="checkbox" name="order_created" value="1"></div>
<?php }?>
<div><?php print _JSHOP_USER?>: <?php echo $this->users_list_select;?></div>
<?php if ($this->config->date_invoice_in_invoice){?>
<div><?php print _JSHOP_INVOICE_DATE?>: <?php echo JHTML::_('calendar', getDisplayDate($order->invoice_date, $this->config->store_date_format), 'invoice_date', 'invoice_date', $this->config->store_date_format , array('class'=>'inputbox', 'size'=>'25', 'maxlength'=>'19'));?></div>
<?php }?>
...
<br/>
<table class="table table-striped" width="100%" id='list_order_items'>
<thead>
<tr>
 <th>
