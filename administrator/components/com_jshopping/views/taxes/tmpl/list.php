...
<?php foreach($rows as $row){ ?>
  <tr class="row<?php echo $i % 2;?>">
   ...
   <td>
    <a href="index.php?option=com_jshopping&controller=exttaxes&back_tax_id=<?php echo $row->tax_id; ?>"><?php echo _JSHOP_EXTENDED_RULE_TAX; ?></a>
   </td>
   <td align="center">
        <?php print "<a href='index.php?option=com_jshopping&controller=taxes&task=edit&tax_id=".$row->tax_id."'><img src='components/com_jshopping/images/icon-16-edit.png'></a>"?>
   </td>
   <td align="center">
