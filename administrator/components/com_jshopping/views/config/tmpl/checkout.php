...
<tr>
    <td class="key">
        <?php echo _JSHOP_SENT_INVOICE_MANUALLY?>
    </td>
    <td>
...
<tr>
    <td class="key">
        <?php echo _JSHOP_SHOW_USER_NUMBER_IN_INVOICE?>
    </td>
    <td>
...
<tr>
    <td class="key">
        <?php echo _JSHOP_SHOW_RETURN_POLICY_IN_EMAIL_ORDER?> (<?php print _JSHOP_URL?>)
    </td>
    <td>
...
<tr>
    <td class="key">
        <?php echo _JSHOP_SHOW_RETURN_POLICY_IN_EMAIL_ORDER?> (<?php print _JSHOP_TEXT?>)
    </td>
    <td>
...
<tr>
    <td class="key">
        <?php echo _JSHOP_SHOW_RETURN_POLICY_IN_PDF?>
    </td>
    <td>
...
<tr>
    <td class="key">
        <?php echo _JSHOP_NORETURN_ALL_PRODUCT?>
    </td>
    <td>
