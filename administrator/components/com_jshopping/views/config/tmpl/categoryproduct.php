...
<tr>
    <td class="key">
        <?php echo _JSHOP_DISPLAY_WEIGHT_AS?>
    </td>
    <td>
...
<tr>
    <td class="key">
        <?php echo _JSHOP_COUNT_MANUFACTURER_ROW;?>
    </td>
    <td>
        <input type="text" name="count_manufacturer_to_row" class="inputbox" value="<?php echo $jshopConfig->count_manufacturer_to_row;?>" />
    </td>
</tr>
<tr>
    <td class="key">
...
<tr>
    <td class="key">
        <?php echo _JSHOP_MANUFACTURER_SORTING;?>
    </td>
    <td>
...
<tr>
    ...
    <td><input type="text" name="count_products_to_page_tophits" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_page_tophits;?>" /></td>
    <td><input type="text" name="count_products_to_page_toprating" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_page_toprating;?>" /></td>
    <td><input type="text" name="count_products_to_page_label" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_page_label;?>" /></td>
    <td><input type="text" name="count_products_to_page_bestseller" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_page_bestseller;?>" /></td>
    <td><input type="text" name="count_products_to_page_random" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_page_random;?>" /></td>
    <td><input type="text" name="count_products_to_page_last" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_page_last;?>" /></td>
</tr>
<tr>
    <td class="key">
        <?php echo _JSHOP_COUNT_PRODUCTS_ROW?>
    </td>
    <td><input type="text" name="count_products_to_row_tophits" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_row_tophits;?>" /></td>
    <td><input type="text" name="count_products_to_row_toprating" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_row_toprating;?>" /></td>
    <td><input type="text" name="count_products_to_row_label" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_row_label;?>" /></td>
    <td><input type="text" name="count_products_to_row_bestseller" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_row_bestseller;?>" /></td>
    <td><input type="text" name="count_products_to_row_random" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_row_random;?>" /></td>
    <td><input type="text" name="count_products_to_row_last" class="inputbox middle" value="<?php echo $jshopConfig->count_products_to_row_last;?>" /></td>
</tr>
...
<tr>
    <td class="key">
        <?php echo _JSHOP_PRODUCT_ATTRIBUT_SORTING." ("._JSHOP_DEPENDENT.")"?>
    </td>
    <td>
...
<tr>
    <td class="key">
        <?php echo _JSHOP_PRODUCT_ATTRIBUT_SORTING." ("._JSHOP_INDEPENDENT.")"?>
    </td>
    <td>
...
<tr>
    <td class="key">
      <?php echo _JSHOP_DISPLAY_REVIEW_WITHOUT_CONFIRM;?>
    </td>
    <td>
