...
<?php foreach($rows as $row){?>
  <tr class="row<?php echo $i % 2;?>">
   ...
   <td>
    ...
    <a href='index.php?option=com_jshopping&controller=addons&task=version&id=<?php print $row->id?>'><img src='components/com_jshopping/images/jshop_info_s.png'></a>
    <?php }?>
   </td>
   <td align="center">
   <?php if ($row->info_file_exist){?>
    <a href='index.php?option=com_jshopping&controller=addons&task=info&id=<?php print $row->id?>'><img src='components/com_jshopping/images/jshop_info_s.png'></a>
   <?php }?>
   </td>
   <td align="center">
   <?php if ($row->usekey){?>
