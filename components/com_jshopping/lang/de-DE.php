...
define('_JSHOP_DISPLAY_NUMBER', 'Anzahl Produkte pro Seite');
define('_JSHOP_TABS_MAIN', 'Haupt');
define('_JSHOP_TABS_VIDEO', 'Videos');
...
define('_JSHOP_NO_PRODUCTS_CART', 'Keine Produkte im Warenkorb');
define('_JSHOP_WISHLIST', 'Wunschliste');
define('_JSHOP_REMOVE', 'Löschen');
define('_JSHOP_ITEM', 'Bezeichnung');
define('_JSHOP_NUMBER', 'Anzahl');
define('_JSHOP_PROD_NUMBER', 'Art. Nr.');  
define('_JSHOP_SINGLEPRICE', 'Einzelpreis');
define('_JSHOP_SINGLEPRICE_NETTO', 'Netto');
...
define('_JSHOP_REGWARN_MAIL','Bitte geben Sie Ihre aktuelle E-Mail Adresse ein.');
...
define('_JSHOP_REGWARN_CLIENT_TYPE', 'Bitte geben Sie den Kundentyp ein');
...
define('_JSHOP_REGWARN_FIRMA_CODE', 'Bitte geben Sie Ihren Firmen-Code ein');
define('_JSHOP_REGWARN_TAX_NUMBER', 'Bitte geben Sie Ihre Steuernummer');
define('_JSHOP_REGWARN_MOBIL_PHONE', 'Bitte geben Sie Ihre Handynummer ein');
define('_JSHOP_REGWARN_MOBIL_PHONE_DELIVERY', 'Bitte geben Sie die Handynummer des Empfängers ein');
define('_JSHOP_REGWARN_EXT_FIELD_1', 'Bitte geben Sie das Extra-Feld 1 ein');
define('_JSHOP_REGWARN_EXT_FIELD_2', 'Bitte geben Sie das Extra-Feld 2 ein');
define('_JSHOP_REGWARN_EXT_FIELD_3', 'Bitte geben Sie das Extra-Feld 3 ein');
define('_JSHOP_REGWARN_EXT_FIELD_1_DELIVERY', 'Bitte geben Sie das Extra-Feld 1 des Empfängers ein');
define('_JSHOP_REGWARN_EXT_FIELD_2_DELIVERY', 'Bitte geben Sie das Extra-Feld 2 des Empfängers ein');
define('_JSHOP_REGWARN_EXT_FIELD_3_DELIVERY', 'Bitte geben Sie das Extra-Feld 3 des Empfängers ein');
...
Benutzername - %s
Passwort - %s');
define('_JSHOP_USEND_MSG', "Hallo %s.
...
define('_JSHOP_EMAIL2', 'E-Mail bestätigen');
define('_JSHOP_SEND_REGISTRATION', 'Registrieren');
define('_JSHOP_USER_EXIST', "Ein Benutzer mit dem Namen %s existiert bereits.\nBitte geben einen anderen Namen ein.");
define('_JSHOP_USER_EXIST_EMAIL', "Ein Benutzer mit der E-Mail Adresse %s existiert bereits.");
define('_JSHOP_REG_SELECT', 'Auswahl');
define('_JSHOP_FIRMA_CODE', 'Firma Code');
define('_JSHOP_VAT_NUMBER', 'UID');
define('_JSHOP_EXT_FIELD_1', 'Zusätzliches Feld 1');
define('_JSHOP_EXT_FIELD_2', 'Zusätzliches Feld 2');
define('_JSHOP_EXT_FIELD_3', 'Zusätzliches Feld 3');
...
define('_JSHOP_NO_SELECT_PRODUCT', 'Sie haben kein Produkt gewählt');
...
// Payment
define('_JSHOP_ACCOUNT_HOLDER', 'Kontoinhaber');
define('_JSHOP_ACCOUNT_NUMBER', 'Kontonummer');
...
define('_JSHOP_EMAIL_PURCHASE_ORDER', 'Bestellung');
define('_JSHOP_DESCRIPTION', 'Beschreibung');
define('_JSHOP_ORDER_NUMBER', 'Bestell-Nummer');
define('_JSHOP_ORDER_DATE', 'Bestell-Datum');
...
define('_JSHOP_ORDER_ITEMS', 'Artikel');
define('_JSHOP_NAME_PRODUCT', 'Artikelbezeichnung');
define('_JSHOP_EAN_PRODUCT', 'Artikelnummer');
define('_JSHOP_TOTAL', 'Betrag');
define('_JSHOP_SUBTOTAL', 'Zwischensumme');
define('_JSHOP_SUBTOTAL_NETTO', 'Nettobetrag');
...
define('_JSHOP_COUPON_DISCOUNT', 'Rabattcoupon');
define('_JSHOP_CUSTOMER_NOTE', 'Bemerkungen vom Kunden');
...
// Account
define('_JSHOP_SAVE', 'Speichern');
define('_JSHOP_MY_ACCOUNT', 'Mein Konto');
define('_JSHOP_ACCOUNT_UPDATE', 'Das Konto wurde aktualisiert');
define('_JSHOP_NEW_PASSWORD', 'Neues Passwort');
define('_JSHOP_NEW_PASSWORD_2', 'Neues Passwort bestätigen');
define('_JSHOP_ADVANCED_SEARCH', 'Erweiterte Suche');
define('_JSHOP_NO_SEARCH_RESULTS', 'Ihre Suche ergab keine Treffer');
define('_JSHOP_EDIT_DATA', 'Benutzer-Einstellungen bearbeiten');
...
define('_JSHOP_SEARCH_CATEGORIES', 'Kategorie');
define('_JSHOP_SEARCH_ALL_CATEGORIES', 'Alle Kategorien');
define('_JSHOP_SEARCH_INCLUDE_SUBCAT', 'inkl. Subkategorien');
define('_JSHOP_SEARCH_MANUFACTURERS', 'Hersteller');
define('_JSHOP_SEARCH_ALL_MANUFACTURERS', 'Alle Hersteller');
define('_JSHOP_SEARCH_PRICE_FROM', 'Preis von');
define('_JSHOP_SEARCH_PRICE_TO', 'Preis bis');
define('_JSHOP_SEARCH_DATE_FROM', 'Datum von');
define('_JSHOP_SEARCH_DATE_TO', 'Datum bis');

// Reviews
define('_JSHOP_COMMENT', 'Kommentar');
define('_JSHOP_NEW_COMMENT', 'Neuer Kommentar');
define('_JSHOP_REVIEWS', 'Kommentare');
define('_JSHOP_REVIEW_NOT_LOGGED', 'Bitte einloggen, um einen Kommentar zu schreiben.');
define('_JSHOP_ADD_REVIEW_PRODUCT', 'Schreiben Sie einen Kommentar zu diesem Artikel!');
define('_JSHOP_REVIEW_USER_NAME', 'Name');
define('_JSHOP_REVIEW_USER_EMAIL', 'E-Mail');
define('_JSHOP_REVIEW_REVIEW', 'Bitte Kommentar schreiben');
define('_JSHOP_REVIEW_MARK_PRODUCT', 'Bewertung für Produkt');
define('_JSHOP_REVIEW_SUBMIT', 'Kommentar schreiben');
define('_JSHOP_REVIEW_MARK', 'Wertung');
...
define('_JSHOP_NO_PRICE_MESSAGE', 'Keine Preis-Mitteilung');
define('_JSHOP_NO_PRICE_ADMIN_MESSAGE', 'Nachricht an den Admin senden');
...
define('_JSHOP_ERROR_ORDER_HASH',"Hash-Fehler");
define("_JSHOP_CHECKOUT_ADDRESS","Rechnungsadresse");
define("_JSHOP_CHECKOUT_PAYMENT","Zahlungsart");
define("_JSHOP_CHECKOUT_SHIPPING","Lieferart");
define("_JSHOP_CHECKOUT_PREVIEW","Bestellung bestätigen");
define("_JSHOP_CHECKOUT_FINISH","Auftrag abgeschlossen");
...
define('_JSHOP_REMOVE_TO_CART', 'In den Warenkorb');
define('_JSHOP_MR', 'Herr');
define('_JSHOP_MS', 'Frau');
define('_JSHOP_FIRMA', 'Firma');
define('_JSHOP_ENTER_CORRECT_INFO_REVIEW','Geben Sie korrekte Kommentardaten ein');
define('_JSHOP_YOUR_REVIEW_SAVE','Ihr Kommentar wurde gespeichert und wird nach der Bestätigung durch den Administrator angezeigt werden.');
define('_JSHOP_YOUR_REVIEW_SAVE_DISPLAY','Ihr Kommentar wurde gespeichert');
define('_JSHOP_ERROR_PAYMENT_FILE_NOT_EXIST','Zahlungsmethode "%s" Fehler, die Datei "%s" existiert nicht.');
define('_JSHOP_GO_TO_CART','Zum Warenkorb');
define('_JSHOP_GO_TO_WISHLIST','Zur Wunschliste');
define('_JSHOP_PRODUCTS_X','Produkte');
define('_JSHOP_INSTALLED_NEW_LANGUAGES','Neue Sprache installieren');
define('_JSHOP_OLD_PRICE','Alter Preis');
define('_JSHOP_DETAILS','Details');
define('_JSHOP_RATING','Wertung');
define('_JSHOP_FOR_USE_COUPON_PLEASE_LOGIN','Für den Einsatz des Coupon bitte anmelden');
define('_JSHOP_EAN', 'Artikelnummer');
define('_JSHOP_PAYMENT_NUMBER', 'Bestell-Nr %s');
define('_JSHOP_ORDER_WITHOUT_REGISTER_CLICK', 'Um die <b>Bestellung ohne Registrierung</b> abzuschließen, klicken Sie bitte');
define('_JSHOP_HERE', 'hier');
define('_JSHOP_PRICE_FOR_QTY', 'Staffelpreise');
define('_JSHOP_PER_PIECE', 'pro Stück');
...
define('_JSHOP_PLUS_SHIPPING', 'zzgl. <a href="%s" target="_blank">Versandkosten</a>');
define('_JSHOP_SHIPPING', 'Versandkosten');
...
define('_JSHOP_ERROR_MAX_SUM_ORDER', 'Maximale Bestellpreis - %s');

define('_JSHOP_SELECT','Bitte auswählen');
define('_JSHOP_HITS','Zugriffe');
define('_JSHOP_BASIC_PRICE', 'Grundpreis');

define('_JSHOP_PAGE_NOT_FOUND', 'Seite nicht gefunden');
define('_JSHOP_HINAME', 'Hallo %s');
define('_JSHOP_DOWNLOAD_INVOICE', 'Download Rechnung');

define('_JSHOP_FREE_DISCOUNT', 'Balance auf dem Coupon');
define('_JSHOP_FROM_PRICE_SHIPPING_FREE', 'ab %s versandkostenfrei');
define('JSHP_ST_', 'St.');
  
define('_JSHOP_CLEAR_FILTERS', 'Reset Filter');
define('_JSHOP_VENDOR', 'Verkäufer');
define('_JSHOP_VIEW_OTHER_VENDOR_PRODUCTS', 'Andere Verkäufer Produkte');
define('_JSHOP_ABOUT_VENDOR', 'Über Verkäufer');

define('_JSHOP_LAST_PRODUCTS','Letzte Produkte');
define('_JSHOP_RANDOM_PRODUCTS','Zufällige Produkte');
define('_JSHOP_BESTSELLER','Bestseller');
define('_JSHOP_LABEL','Label');
define('_JSHOP_TOP_RATING','Top-Bewertung');
...
define('_JSHOP_SEARCH_FOR','Suche nach');
...
define('_JSHOP_REGWARN_MNAME','Bitte geben Sie Ihren zweiten Vornamen ein.');
define('_JSHOP_REGWARN_BIRTHDAY','Bitte geben Sie Ihren Geburtstag ein.');
define('_JSHOP_REGWARN_MNAME_DELIVERY','Bitte wählen Sie den zweiten Vornamen des Empfängers aus.');
define('_JSHOP_REGWARN_BIRTHDAY_DELIVERY','Bitte wählen Sie den Geburtstag des Empfängers aus.');

define('_JSHOP_USER_NUMBER','Kundennummer');
define('_JSHOP_NO_RETURN_DESCRIPTION','Ich stimme ausdrücklich zu, dass Sie vor Ablauf der Widerrufsfrist mit der Ausführung des Vertrages beginnen. Mir ist bekannt, dass ich durch diese Zustimmung mit Beginn der Ausführung des Vertrages mein Widerrufsrecht verliere.');
define('_JSHOP_NO_PRODUCTS_AFTER_FILTER','Keine verwandten Produkt');
?>